...
img_path = os.path.join(cur_dir,'Original_data/wave/healthy')
...
for images in img_list:
    ...
    cur_img_path = os.path.join('Original_data/wave/healthy/',images)
    print(name)
    ...
    augumented_train = os.path.join(cur_dir, 'wave/healthy/')
